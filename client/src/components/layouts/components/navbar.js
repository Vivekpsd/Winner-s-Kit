...
const navbar = () => {
    ...
    return (
        ...
        <Navbar.Brand href="#home">E-GURUKUL</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
            <Nav.Link as={Link} to="/" eventKey="/home" href="#home">Home</Nav.Link>
            <Nav.Link as={Link} to="/courses" href="#link">Courses</Nav.Link>
            <Nav.Link as={Link} to="/gallery" href="#link">Gallery</Nav.Link>
